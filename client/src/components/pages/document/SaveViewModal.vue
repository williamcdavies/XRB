...
<template>
    <div class="fixed inset-0 z-20 flex items-center justify-center bg-black/50" @click.self="emit('close')">
        <div class="bg-xrb-bg-1 border border-xrb-border rounded-lg shadow-xl w-[360px] max-w-[90vw]" @click.stop>
            <!-- Header -->
            <div
                class="flex items-center justify-between px-4 py-3 border-b border-xrb-border bg-xrb-bg-2 rounded-t-lg">
