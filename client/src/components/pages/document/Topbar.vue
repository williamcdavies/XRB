...
<template>
    <div class="flex flex-row items-center h-10 w-full bg-xrb-bg-2 border-b border-xrb-border px-3 gap-3">
        ...
        <button @click="router.push('/dashboard');" class="rounded-none tooltip tooltip-bottom tooltip-neutral group"
            data-tip="Home">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="size-4 text-xrb-text-secondary hover:text-white transition-colors duration-150">
                <path
