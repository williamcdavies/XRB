        ...
        <ul v-else class="menu flex-1 overflow-y-auto p-2 gap-1">
            <li v-for="item in sortedItems" :key="item.path">
                <button
                    ...
                    :class="
                        item.type === 'file' && item.path === selectedPath
                ...
                >
                    ...
                    <svg
                        ...
                        stroke-width="1"
                        stroke="currentColor"
                        class="size-5 shrink-0 text-xrb-text-secondary"
                    >
                        <path
                            stroke-linecap="round"
                            stroke-linejoin="round"
                    ...
                    <span v-if="item.type === 'file' && item.size != null" class="text-xs text-xrb-text-secondary shrink-0">
                    ...
                    <div v-if="item.type === 'file'" class="flex items-center gap-1 shrink-0">
                        <button
                            ...
                            title="Download"
                            @click.stop="emit('download', item.path)"
                        >
                        ...
                        <button
                            ...
                            title="Delete"
                            @click.stop="emit('delete', item.path, item.name)"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
