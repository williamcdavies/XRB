                ...
                <ul class="menu w-full grow p-0 gap-1">
                    ...
                    <li class="pb-8">
                        <label for="dashboard-drawer" aria-label="toggle sidebar"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linejoin="round"
                                ...
                                class="inline-block group-stroke-xrb-text-secondary group-hover:stroke-xrb-text-primary size-6 transition-colors duration-300">
                                <path
                    ...
                    <li v-if="accessToken">
                        <button @click="handleNavigation('document')" class="p-4 rounded-none tooltip tooltip-right tooltip-neutral group" data-tip="New">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                                stroke="currentColor"
                                class="group-stroke-xrb-text-secondary group-hover:stroke-xrb-text-primary size-6 transition-colors duration-300">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                            <span
                                class="is-drawer-close:hidden select-none transition-colors duration-200 group-text-xrb-text-secondary group-hover:text-xrb-text-primary leading-6">New</span>
                        </button>
                    </li>
                    ...
                    <li>
                        <button @click="handleNavigation('home')"
                            ...
                            <span
                                class="is-drawer-close:hidden select-none transition-colors duration-200 group-text-xrb-text-secondary group-hover:text-xrb-text-primary leading-6">Home</span>
                        </button>
                    </li>
                    ...
                    <li>
                        <button @click="handleNavigation('files')"
                            ...
                            <span
                                class="is-drawer-close:hidden select-none transition-colors duration-200 group-text-xrb-text-secondary group-hover:text-xrb-text-primary leading-6">Files</span>
                        </button>
                    </li>
                    ...
                    <li v-if="accessToken">
                        <button @click="handleNavigation('groups')"
                            ...
                            <span
                                class="is-drawer-close:hidden select-none transition-colors duration-200 group-text-xrb-text-secondary group-hover:text-xrb-text-primary leading-6">Groups</span>
                        </button>
                    </li>
                    ...
                    <div class="mt-auto border-t-1 border-xrb-border-1">
                        ...
                        <li v-if="accessToken">
                            <button @click="handleNavigation('account')"
                                ...
                                <span
                                    class="is-drawer-close:hidden select-none transition-colors duration-200 group-text-xrb-text-secondary group-hover:text-xrb-text-primary leading-6">Account</span>
                            </button>
                        </li>
                    </div>
